export const modulo = {
  ...
  teoria: [
    ...
    },
    {
      ...
      <p><strong>Propriedades importantes:</strong></p>
      <ul>
        <li><strong>Termo médio:</strong> Em uma PG com três termos consecutivos (x, y, z), temos y<sup>2</sup> = x · z (y é a média geométrica de x e z).</li>
        ...
        <li><strong>Soma dos termos infinitos (PG convergente):</strong> Se |q| < 1, a soma infinita é S<sub>∞</sub> = a<sub>1</sub> / (1 - q).</li>
  ...
  exemplos: [
    ...
    },
    {
      ...
      resolucao: `<p><strong>a) 6º termo:</strong></p>
        ...
        <p>Como |q| = 1/2 < 1, a soma infinita existe: S<sub>∞</sub> = a<sub>1</sub> / (1 - q).</p>
        <p>S<sub>∞</sub> = 3 / (1 - 1/2) = 3 / (1/2) = 6.</p>
        <p><strong>Respostas:</strong> a<sub>6</sub> = 3/32 e S<sub>∞</sub> = 6.</p>`,
